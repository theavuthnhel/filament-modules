...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/theavuthnhel/modules.svg?style=flat-square)](https://packagist.org/packages/theavuthnhel/modules)
...
[![Total Downloads](https://img.shields.io/packagist/dt/theavuthnhel/modules.svg?style=flat-square)](https://packagist.org/packages/theavuthnhel/modules)
...
```bash
composer require theavuthnhel/modules:^4
```
...
use TheavuthNhel\Modules\ModulesPlugin;
...
```php
use TheavuthNhel\Modules\Resource;
```
...
```php
use TheavuthNhel\Modules\ChartWidget;
```
...
```php
use TheavuthNhel\Modules\StatsOverviewWidget;
```
...
- [Sam Maosa](https://github.com/theavuthnhel726)
